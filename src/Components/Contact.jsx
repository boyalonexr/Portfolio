  ...
  return (
    ...
    >
            ...
            >
              ...
              <div>
                ...
                <a
                  ...
                  ${ contact.hover ? ' hover:text-[#3B82F6]' : '' }
                  `}
                >
                  {contact.label}
                </a>
        ...
        >
          <div>
            ...
            <input
              ...
              className="w-full p-3 rounded-lg bg-[#222]/60 text-white focus:outline-none focus:ring-2 focus:ring-[#3B82F6]"
            />
          </div>
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            type="submit"
            className="w-full py-3 bg-[#3B82F6] text-white rounded-lg font-medium shadow-md hover:bg-[#2563EB] transition-all duration-300"
          >
            Send Message
          </motion.button>
        </motion.form>
      ...
      <p className="text-white text-sm text-center">
        ...
        <span className="text-[#3B82F6] font-medium">BoyAlone</span>. All rights reserved.
      </p>
